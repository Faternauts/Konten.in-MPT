...
const activeChallenges = [
  {
    ...
    category: "Super Bowl",
    description:
      "Create the best remix of the iconic Super Bowl halftime show ad and compete for the grand prize",
    isEntered: true,
    myRank: 45,
  },
  {
    ...
    category: "Tech",
    description:
      "Submit your vision of Apple's future tech - top submission wins",
    isEntered: false,
  },
  {
    id: 3,
    ...
    category: "Fashion",
    description:
      "Compete to create the most impactful sustainability message for Nike",
    isEntered: true,
    myRank: 12,
  },
  {
    ...
    category: "Food",
    description:
      "Create a mouth-watering remix that makes people crave fast food",
    isEntered: false,
  },
  {
    id: 5,
              ...
              {activeChallenges.filter((c) => c.isEntered).length > 0 && (
                <div>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {activeChallenges
                      .filter((c) => c.isEntered)
                      .map((challenge) => (
                        <Card
                          key={challenge.id}
                          className="overflow-hidden hover:shadow-xl transition-all group flex flex-col border-2 border-primary/20"
                        >
                          ...
                          <CardContent className="p-5 flex flex-col flex-1">
                            <div className="mb-3 min-h-[60px]">
                              <h3 className="font-bold text-lg mb-1 text-balance">
                                {challenge.title}
                              </h3>
                            ...
                            <div className="space-y-3 mb-4">
                              ...
                              <div className="pt-2">
                                ...
                                <Progress
                                  value={(challenge.daysLeft / 30) * 100}
                                  className="h-2"
                                />
                              </div>
                            </div>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {activeChallenges
                      ...
                      .map((challenge) => (
                        <Card
                          key={challenge.id}
                          className="overflow-hidden hover:shadow-xl transition-all group flex flex-col"
                        >
                          <div className="relative overflow-hidden">
                            <img
                              src={challenge.image || "/placeholder.svg"}
                    ...
                    <CardContent className="p-5">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-muted-foreground">
                          {formatNumberWithCommas(winner.votes)} votes
                        </span>
                      </div>
                    </CardContent>
                  </Card>
