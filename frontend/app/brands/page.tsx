...
export default function BrandDashboard() {
  ...
  const [campaignViewModes, setCampaignViewModes] = useState<
    Record<number, "reach" | "conversion">
  >({});
  ...
  const fetchAndAnalyzePrompts = async () => {
    ...
    try {
      ...
      console.warn(
        "Using fallback prompt analysis data (API unavailable):",
        error
      );
      ...
      setPromptAnalysis({
        ...
        emotionalTone:
          "Energetic and aspirational, focusing on athletic achievement and urban style",
        styleReferences: [
          "Street Art",
          "Modern Athletic",
          "Urban Fashion",
        ...
        intent:
          "Users aim to enhance Nike's athletic imagery with modern, urban aesthetics while maintaining brand recognition",
      });
    } finally {
      ...
      try {
        ...
        if (promptsData.length > 0) {
          const transformedRemixes = promptsData
            .map((prompt: any) => {
              const adImage =
                prompt.ads?.image_url ||
                "/nike-athletic-shoe-advertisement.jpg";
  ...
  const toggleCampaignViewMode = (campaignId: number) => {
    const newMode =
      campaignViewModes[campaignId] === "conversion" ? "reach" : "conversion";
    ...
    <div className="min-h-screen pb-12">
      ...
      <section className="relative py-16 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden bg-gradient-to-br from-primary/5 to-background">
          ...
          <div
            className="absolute top-[10%] left-[15%] w-[150px] h-[150px] bg-primary/60 rounded-full blur-[60px] animate-float-1"
            style={{ animationDelay: "0s" }}
          ></div>
          <div
            className="absolute top-[25%] right-[20%] w-[120px] h-[120px] bg-primary/55 rounded-full blur-[50px] animate-float-2"
            style={{ animationDelay: "0.3s" }}
          ></div>
          <div
            className="absolute bottom-[30%] left-[10%] w-[180px] h-[180px] bg-primary/65 rounded-full blur-[70px] animate-float-3"
            style={{ animationDelay: "0.6s" }}
          ></div>
          <div
            className="absolute top-[40%] left-[45%] w-[140px] h-[140px] bg-primary/50 rounded-full blur-[55px] animate-float-4"
            style={{ animationDelay: "0.9s" }}
          ></div>
          <div
            className="absolute bottom-[20%] right-[15%] w-[160px] h-[160px] bg-primary/58 rounded-full blur-[65px] animate-float-1"
            style={{ animationDelay: "1.2s" }}
          ></div>
          <div
            className="absolute top-[60%] right-[40%] w-[130px] h-[130px] bg-primary/52 rounded-full blur-[58px] animate-float-2"
            style={{ animationDelay: "1.5s" }}
          ></div>
          <div
            className="absolute top-[15%] left-[60%] w-[145px] h-[145px] bg-primary/62 rounded-full blur-[62px] animate-float-3"
            style={{ animationDelay: "1.8s" }}
          ></div>
          <div
            className="absolute bottom-[40%] right-[35%] w-[125px] h-[125px] bg-primary/48 rounded-full blur-[52px] animate-float-4"
            style={{ animationDelay: "2.1s" }}
          ></div>
          <div
            className="absolute top-[70%] left-[30%] w-[170px] h-[170px] bg-primary/56 rounded-full blur-[68px] animate-float-1"
            style={{ animationDelay: "0.4s" }}
          ></div>
          <div
            className="absolute bottom-[15%] left-[55%] w-[135px] h-[135px] bg-primary/54 rounded-full blur-[60px] animate-float-2"
            style={{ animationDelay: "0.7s" }}
          ></div>
          <div
            className="absolute top-[35%] right-[10%] w-[155px] h-[155px] bg-primary/60 rounded-full blur-[64px] animate-float-3"
            style={{ animationDelay: "1.0s" }}
          ></div>
          <div
            className="absolute bottom-[50%] left-[75%] w-[142px] h-[142px] bg-primary/51 rounded-full blur-[56px] animate-float-4"
            style={{ animationDelay: "1.3s" }}
          ></div>
          <div
            className="absolute top-[50%] left-[5%] w-[165px] h-[165px] bg-primary/57 rounded-full blur-[66px] animate-float-1"
            style={{ animationDelay: "1.6s" }}
          ></div>
          <div
            className="absolute bottom-[10%] right-[50%] w-[138px] h-[138px] bg-primary/53 rounded-full blur-[59px] animate-float-2"
            style={{ animationDelay: "1.9s" }}
          ></div>
          <div
            className="absolute top-[80%] right-[25%] w-[148px] h-[148px] bg-primary/59 rounded-full blur-[63px] animate-float-3"
            style={{ animationDelay: "0.2s" }}
          ></div>
          <div
            className="absolute top-[20%] left-[85%] w-[128px] h-[128px] bg-primary/49 rounded-full blur-[54px] animate-float-4"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Manage campaigns and predict ad performance
              </p>
            </div>
            <Button
              size="lg"
      ...
      <div className="container mx-auto px-4 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="hover:shadow-lg transition-all">
            ...
            <CardContent>
              <div className="text-3xl font-bold">
                {campaignStats.totalRemixes.toLocaleString()}
              </div>
          ...
          <Card className="hover:shadow-lg transition-all">
            ...
            <CardContent>
              <div className="text-3xl font-bold">
                {campaignStats.totalEngagement.toLocaleString()}
              </div>
              <p className="text-xs text-muted-foreground mt-1 flex items-center gap-1">
                <TrendingUp className="h-3 w-3 text-green-500" />
                        ...
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                onClick={() =>
                                  toggleCampaignViewMode(campaign.id)
                                }
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                          <div>
                            ...
                            <div className="text-2xl font-bold">
                              {campaign.remixes.toLocaleString()}
                            </div>
                          </div>
                          <div>
                            <div className="text-sm text-muted-foreground mb-1">
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  <div className="text-muted-foreground">
                    ...
                    <p className="text-sm">
                      Nike prompts will appear here once users start remixing
                    </p>
                  </div>
                </CardContent>
              </Card>
